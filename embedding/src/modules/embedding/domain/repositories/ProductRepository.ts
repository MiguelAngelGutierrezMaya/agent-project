 ...
 *
 * @description
 * Defines the contract for interacting with product embedding data.
 * This layer abstracts the underlying data source from the application logic.
 */
export interface ProductRepository {
  /**
   * Retrieves product embeddings that are pending embedding generation.
   *
   * @param schemaName - The schema name to query for product embeddings.
   * @returns A promise that resolves to an array of ProductEmbedding objects.
   */
  ...
  /**
   * Retrieves product embeddings that are in processing state with batch_id
   *
   * @param schemaName - The schema name to query for product embeddings
   * @returns A promise that resolves to an array of ProductEmbedding objects in processing state
   */
