...
import {
  ...
  RouteNotFoundError,
} from '@shared/utils/errors/methods';
import { ModuleNotFoundError } from '@shared/utils/errors/modules';
...
export class Router {
  ...
  static instantiate(app: Application): Router {
    ...
    const route: string | undefined = app.routes.find(
      route => route === app.pathname
    );
